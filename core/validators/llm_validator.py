...
class LLMValidator:
    ...
    def enhance(
        ...
        *,
        ...
        # ── Title Enhancement ──
        if enhanced.title.score < LLM_ENHANCEMENT_THRESHOLD:
            logger.info(
        ...
        # ── Authors Enhancement ──
        if enhanced.authors.score < LLM_ENHANCEMENT_THRESHOLD:
            logger.info(
        ...
        if enhanced.abstract.score < LLM_ENHANCEMENT_THRESHOLD:
            logger.info(
