...
class TestAuthorCleaning:
    ...
    def test_authors_with_joined_spans_and_private_use_footnotes(self):
        """Recover names joined by an affiliation marker and remove U+F02A."""
        authors = ["Nguyễn Đức Anh1 Bùi Thị Vân Anh", "2 Nguyễn Trọng Tuệ\uf02a"]
        cleaned, _ = MetadataAuthorCleaner.clean_all(authors)
        assert cleaned == ["Nguyễn Đức Anh", "Bùi Thị Vân Anh", "Nguyễn Trọng Tuệ"]
...
class TestAbstractCleaning:
    ...
    def test_abstract_layout_line_breaks_joined(self):
        """PDF layout line breaks are joined into continuous prose."""
        abstract = (
            "First paragraph of the abstract.\n\n"
            "Second paragraph continues here."
        )
        cleaned, _ = AbstractCleaner.clean(abstract)
        assert cleaned == "First paragraph of the abstract. Second paragraph continues here."
