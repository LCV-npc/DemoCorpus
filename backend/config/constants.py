...
ABSTRACT_START_PATTERN = re.compile(
    r"^\s*(abstract|summary|tóm\s*tắt)\s*[:\.\-]?\s*",
...
HEADER_FOOTER_PATTERNS = [
    ...
    # Vietnamese journal mastheads, e.g. "TẠP CHÍ Y HỌC VIỆT NAM
    # TẬP 554 - THÁNG 9 - SỐ 1 - 2025".  They are repeated page headers,
    # never article titles.
    re.compile(
        r"\btạp\s*chí\b.*\b(?:tập|tháng|số)\b",
        re.IGNORECASE,
    ),
]
